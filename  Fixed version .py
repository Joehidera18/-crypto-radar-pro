...
def deriv(sym):
    # Binance.US does not provide perpetual-futures data.
    # Return unavailable instead of failing the whole scan.
    return {"funding":0.0,"oi_change":0.0,"taker_ratio":1.0,"available":False}
