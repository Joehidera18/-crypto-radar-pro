...
# ============================================================
# CRYPTO RADAR PRO v15.1 — DAY-TRADING RADAR + FOCUS MODE
# ============================================================
#
# Goals:
...
<title>Crypto Radar Pro V15.1</title>
<style>
...
<body>
<div class="wrap">
<div class="brand"><span class="chip v11">V15.1</span><span class="chip live">● LIVE PRICES</span><span class="chip locked">🔒 MANUAL RANKINGS</span><span class="chip">⚡ HARD STOP + CACHE</span></div>
...
<div class="notice"><b>No automatic reshuffling in V15.1.</b> Prices stay live, but the ranking only changes when you press <b>Refresh Rankings</b>. Tap <b>Focus</b> and the coin stays open while you read.</div>
...
@app.route("/version")
def version():
    return {"version":"15.1-hard-stop","auto_ranking_refresh":False}
