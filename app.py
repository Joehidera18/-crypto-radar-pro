...
# ============================================================
# CRYPTO RADAR PRO v15 — DAY-TRADING RADAR + FOCUS MODE
# ============================================================
#
# Goals:
...
def technical_for_asset(asset, available_symbols, horizon="4h"):
    ...
    try:
        frames={}
        raw1m=req_json(f"{BINANCE_US}/api/v3/klines",{"symbol":pair,"interval":"1m","limit":220},timeout=3,retries=1)
        raw5m=req_json(f"{BINANCE_US}/api/v3/klines",{"symbol":pair,"interval":"5m","limit":220},timeout=3,retries=1)
        raw15m=req_json(f"{BINANCE_US}/api/v3/klines",{"symbol":pair,"interval":"15m","limit":220},timeout=3,retries=1)
        raw1h=req_json(f"{BINANCE_US}/api/v3/klines",{"symbol":pair,"interval":"1h","limit":220},timeout=3,retries=1)
        raw4h=req_json(f"{BINANCE_US}/api/v3/klines",{"symbol":pair,"interval":"4h","limit":220},timeout=3,retries=1)
...
<title>Crypto Radar Pro V15</title>
<style>
...
<body>
<div class="wrap">
<div class="brand"><span class="chip v11">V15</span><span class="chip live">● LIVE PRICES</span><span class="chip locked">🔒 MANUAL RANKINGS</span><span class="chip">⚡ 25s DEADLINE + CACHE</span></div>
...
<div class="notice"><b>No automatic reshuffling in V15.</b> Prices stay live, but the ranking only changes when you press <b>Refresh Rankings</b>. Tap <b>Focus</b> and the coin stays open while you read.</div>
...
@app.route("/version")
def version():
    return {"version":"15.0-deadline-engine","auto_ranking_refresh":False}
