...
# ============================================================
# CRYPTO RADAR PRO v13.1 — DAY-TRADING RADAR + FOCUS MODE
# ============================================================
#
# Goals:
...
PRELIM_LIMIT = env_int("PRELIM_LIMIT", 40, 15, 100)
TECH_LIMIT = env_int("TECH_LIMIT", 14, 6, 30)
NEWS_LIMIT = env_int("NEWS_LIMIT", 8, 3, 20)
...
def req_json(url, params=None, timeout=7, retries=1, extra_headers=None):
    # Fast-scan guard: no external provider may monopolize a scan.
    timeout = min(float(timeout or 7), 7.0)
    retries = 1
...
<title>Crypto Radar Pro V13.1</title>
<style>
...
<body>
<div class="wrap">
<div class="brand"><span class="chip v11">V13.1</span><span class="chip live">● LIVE PRICES</span><span class="chip locked">🔒 MANUAL RANKINGS</span><span class="chip">⚡ FAST SCAN</span></div>
...
@app.route("/version")
def version():
    return {"version":"13.1-fast-scan","auto_ranking_refresh":False}
