...
def enhanced_market_regime(rows, fng_value):
    ...
    sample=[x for x in rows[:100] if str(x.get("symbol","")).upper() not in STABLES]
...
<section class="hero"><div class="eyebrow">Market intelligence · day trading</div><h1>Find the setup before the crowd.</h1><p>Live crypto radar combining price action, market structure, liquidity, order flow, derivatives positioning, news, social context and broad-market regime into a disciplined trade plan.</p></section>
